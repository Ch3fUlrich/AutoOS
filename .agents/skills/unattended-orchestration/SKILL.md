...
- R-host-05: Cap local client workers at 1 per orchestrator, only when MemAvailable >= 2500 MB; else use Agent-tool subagents. (why: one client worker costs ~0.7 GB; source: ps 2026-09-26T07:34Z)
