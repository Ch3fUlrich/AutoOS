...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Universität Basel"
Config.profilename = "UniBasel"
Config.url = "http://its.unibas.ch"
Config.email = "support-its@unibas.ch"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.unibas.ch"
...
Config.user_realm = "unibas.ch"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.unibas.ch']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous2802@unibas.ch"
